...
# todo: remove this; replace config with a json file
import os
import sys
import inspect
...
# load models
# segmentation model
with open(os.path.join(dirname, 'Model/crf_model.pkl'), 'rb') as fid:
    crf = pickle.load(fid)
# extraction
with open(os.path.join(dirname, 'Model/rf.pkl'), 'rb') as fid:
    rf = pickle.load(fid)
...
kde_ntag1 = pickle.load(open(os.path.join(dirname, 'Model/kde_ntag_en.pkl'), "rb"), encoding="latin1")
kde_ltag1 = pickle.load(open(os.path.join(dirname, 'Model/kde_ltag_en.pkl'), "rb"), encoding="latin1")
kde_dtag1 = pickle.load(open(os.path.join(dirname, 'Model/kde_dtag_en.pkl'), "rb"), encoding="latin1")
kde_atag1 = pickle.load(open(os.path.join(dirname, 'Model/kde_atag_en.pkl'), "rb"), encoding="latin1")
kde_wtag1 = pickle.load(open(os.path.join(dirname, 'Model/kde_wtag_en.pkl'), "rb"), encoding="latin1")
kde_gtag1 = pickle.load(open(os.path.join(dirname, 'Model/kde_gtag_en.pkl'), "rb"), encoding="latin1")
kde_llen1 = pickle.load(open(os.path.join(dirname, 'Model/kde_llen_en.pkl'), "rb"), encoding="latin1")
kde_tlen1 = pickle.load(open(os.path.join(dirname, 'Model/kde_tlen_en.pkl'), "rb"), encoding="latin1")
kde_ntag2 = pickle.load(open(os.path.join(dirname, 'Model/kde_ntag_de.pkl'), "rb"), encoding="latin1")
kde_ltag2 = pickle.load(open(os.path.join(dirname, 'Model/kde_ltag_de.pkl'), "rb"), encoding="latin1")
kde_dtag2 = pickle.load(open(os.path.join(dirname, 'Model/kde_dtag_de.pkl'), "rb"), encoding="latin1")
kde_atag2 = pickle.load(open(os.path.join(dirname, 'Model/kde_atag_de.pkl'), "rb"), encoding="latin1")
kde_wtag2 = pickle.load(open(os.path.join(dirname, 'Model/kde_wtag_de.pkl'), "rb"), encoding="latin1")
kde_gtag2 = pickle.load(open(os.path.join(dirname, 'Model/kde_gtag_de.pkl'), "rb"), encoding="latin1")
kde_llen2 = pickle.load(open(os.path.join(dirname, 'Model/kde_llen_de.pkl'), "rb"), encoding="latin1")
kde_tlen2 = pickle.load(open(os.path.join(dirname, 'Model/kde_tlen_de.pkl'), "rb"), encoding="latin1")
...
idxx = np.load(os.path.join(dirname, 'idxx.npy'))
...
def segment(txt, ref_prob0, valid):  # ref_prob is the probability given by reference extraction
    ...
    if sum(valid) <= 0 and tmp <= 0:  # no valid references to parse? If we proceeded without entering the next loop
                                      # some variables are left unintialized (pb, tlin and llin)
        return ref_id
